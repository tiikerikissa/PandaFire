...
void World::LoadConfigSettings(bool reload)
{
    ...
    m_int_configs[CONFIG_AUTO_SERVER_RESTART_HOUR] = ConfigMgr::GetIntDefault("Server.Auto.RestartHour", 8);
    if (m_int_configs[CONFIG_AUTO_SERVER_RESTART_HOUR] > 23)
    {
        m_int_configs[CONFIG_AUTO_SERVER_RESTART_HOUR] = 8;
    }
...
void World::SetInitialWorldSettings()
{
	...
	sLog->outInfo(LOG_FILTER_SERVER_LOADING, "Loading Creature Loot Currency Templates...");
	sObjectMgr->LoadCurrencyOnKill();

	sLog->outInfo(LOG_FILTER_SERVER_LOADING, "Loading Gameobject Loot Currency Templates...");
	sObjectMgr->LoadCurrencyOnGob();
	...
	sLog->outInfo(LOG_FILTER_GENERAL, "Loading missing KeyChains...");
