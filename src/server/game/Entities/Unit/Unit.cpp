...
{
    WorldPacket data(SMSG_ATTACK_STOP, 8 + 8);
    ...
    if (!forced)
    {
        switch (mtype)
        {
            ...
            { // 5.4.8
                ...
                uint8 bitOrder[8] = {4, 1, 7, 6, 3, 2, 5, 0};
            ...
            { // 5.4.8
                ...
                uint8 bitOrder[8] = {3, 0, 1, 4, 7, 5, 6, 2};
                data.WriteBitInOrder(guid, bitOrder);
            ...
            { // 5.4.8
                ...
                uint8 bitOrder[8] = {7, 4, 0, 3, 2, 5, 6, 1};
                data.WriteBitInOrder(guid, bitOrder);
            ...
            { // 5.4.8
                ...
                uint8 bitOrder[8] = {5, 6, 7, 3, 4, 2, 1, 0};
                data.WriteBitInOrder(guid, bitOrder);
    ...
    else
    {
        ...
        switch (mtype)
        {
            ...
            { // 5.4.8
                ...
                uint8 bitOrder[8] = {6, 7, 3, 1, 2, 0, 4, 5};
                data.WriteBitInOrder(guid, bitOrder);
            ...
            { // 5.4.8
                ...
                uint8 bitOrder[8] = {7, 1, 0, 2, 4, 3, 6, 5};
				data.WriteBitInOrder(guid, bitOrder);
...
void Unit::SendPlaySpellVisualKit(uint32 id, uint32 unkParam)
{
	...
	uint8 bitOrder[8] = { 4, 2, 6, 5, 1, 3, 0, 7 };
    data.WriteBitInOrder(guid, bitOrder);
...
void Unit::WriteMovementInfo(WorldPacket& data, Movement::ExtraMovementStatusElement* extras /*= NULL*/)
{
	...
	if (!sequence)
    {
		sLog->outError(LOG_FILTER_NETWORKIO, "Unit::WriteMovementInfo: No movement sequence found for opcode %s", GetOpcodeNameForLogging(data.GetOpcode(), true).c_str());
        return;
    }
