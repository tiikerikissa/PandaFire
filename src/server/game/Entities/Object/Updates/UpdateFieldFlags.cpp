...
uint32 UnitUpdateFieldFlags[PLAYER_END] =
{
	...
	UF_FLAG_PRIVATE | UF_FLAG_OWNER | UF_FLAG_UNUSED1,         //UNIT_FIELD_POWER_REGEN_FLAT_MODIFIER
	UF_FLAG_PRIVATE | UF_FLAG_OWNER | UF_FLAG_UNUSED1,         //UNIT_FIELD_POWER_REGEN_FLAT_MODIFIER+1
	UF_FLAG_PRIVATE | UF_FLAG_OWNER | UF_FLAG_UNUSED1,         //UNIT_FIELD_POWER_REGEN_FLAT_MODIFIER+2
	UF_FLAG_PRIVATE | UF_FLAG_OWNER | UF_FLAG_UNUSED1,         //UNIT_FIELD_POWER_REGEN_FLAT_MODIFIER+3
	UF_FLAG_PRIVATE | UF_FLAG_OWNER | UF_FLAG_UNUSED1,         //UNIT_FIELD_POWER_REGEN_FLAT_MODIFIER+4
	UF_FLAG_PRIVATE | UF_FLAG_OWNER | UF_FLAG_UNUSED1,         //UNIT_FIELD_POWER_REGEN_INTERRUPTED_FLAT_MODIFIER
	UF_FLAG_PRIVATE | UF_FLAG_OWNER | UF_FLAG_UNUSED1,         //UNIT_FIELD_POWER_REGEN_INTERRUPTED_FLAT_MODIFIER+1
	UF_FLAG_PRIVATE | UF_FLAG_OWNER | UF_FLAG_UNUSED1,         //UNIT_FIELD_POWER_REGEN_INTERRUPTED_FLAT_MODIFIER+2
	UF_FLAG_PRIVATE | UF_FLAG_OWNER | UF_FLAG_UNUSED1,         //UNIT_FIELD_POWER_REGEN_INTERRUPTED_FLAT_MODIFIER+3
	UF_FLAG_PRIVATE | UF_FLAG_OWNER | UF_FLAG_UNUSED1,         //UNIT_FIELD_POWER_REGEN_INTERRUPTED_FLAT_MODIFIER+4
...
uint32 GameObjectUpdateFieldFlags[GAMEOBJECT_END] =
{
    ...
    UF_FLAG_PUBLIC,                                         // GAMEOBJECT_FIELD_FLAGS
    ...
    UF_FLAG_DYNAMIC,                                        // GAMEOBJECT_FIELD_STATE_SPELL_VISUAL_ID
    UF_FLAG_PUBLIC,                                         // GAMEOBJECT_FIELD_FACTION_TEMPLATE
    UF_FLAG_PUBLIC,                                         // GAMEOBJECT_FIELD_LEVEL
    UF_FLAG_PUBLIC,                                         // GAMEOBJECT_FIELD_PERCENT_HEALTH
};
