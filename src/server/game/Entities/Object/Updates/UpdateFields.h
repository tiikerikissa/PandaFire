...
enum EUnitFields
{
	...
	UNIT_DYNAMIC_FLAGS                                  = OBJECT_END + 43,
...
enum EPlayerFields
{
    PLAYER_DUEL_ARBITER                              = UNIT_END + 0x000, // size 2, flags MIRROR_ALL
    PLAYER_FLAGS                                     = UNIT_END + 0x002, // size 1, flags MIRROR_ALL
    PLAYER_GUILDRANK                                 = UNIT_END + 0x003, // size 1, flags MIRROR_ALL
    PLAYER_FIELD_GUILD_DELETE_DATE                   = UNIT_END + 0x004, // size 1, flags MIRROR_ALL
    PLAYER_GUILDLEVEL                                = UNIT_END + 0x005, // size 1, flags MIRROR_ALL
	PLAYER_FIELD_HAIR_COLOR_ID                       = UNIT_END + 0x006, // size 1, flags MIRROR_ALL
    PLAYER_BYTES_2                                   = UNIT_END + 0x007, // size 1, flags MIRROR_ALL
    PLAYER_BYTES_3                                   = UNIT_END + 0x008, // size 1, flags MIRROR_ALL
    PLAYER_DUEL_TEAM                                 = UNIT_END + 0x009, // size 1, flags MIRROR_ALL
    PLAYER_GUILD_TIMESTAMP                           = UNIT_END + 0x00A, // size 1, flags MIRROR_ALL
    PLAYER_QUEST_LOG_1_1                             = UNIT_END + 0x00B, // size 750, flags MIRROR_PARTY
	PLAYER_FIELD_VISIBLE_ITEMS                       = UNIT_END + 0x2F9, // Size: 19, Flags: UF_FLAG_PUBLIC
	PLAYER_VISIBLE_ITEM_ENCHANTMENT                  = UNIT_END + 0x30D, // Size: 19, Flags: UF_FLAG_PARTY
	PLAYER_CHOSEN_TITLE                              = UNIT_END + 0x31F, // size 1, flags MIRROR_ALL
	PLAYER_FAKE_INEBRIATION                          = UNIT_END + 0x320, // size 1, flags MIRROR_ALL
	PLAYER_FIELD_VIRTUAL_PLAYER_REALM                = UNIT_END + 0x321, // size 1, flags MIRROR_ALL
	PLAYER_CURRENT_SPEC_ID                           = UNIT_END + 0x322, // size 1, flags MIRROR_ALL
	PLAYER_FIELD_TAXI_MOUNT_ANIM_KIT_ID              = UNIT_END + 0x323, // size 1, flags MIRROR_ALL
	PLAYER_FIELD_CURRENT_BATTLE_PET_BREED_QUALITY    = UNIT_END + 0x324, // size 1, flags MIRROR_ALL
	PLAYER_FIELD_INV_SLOT_HEAD                       = UNIT_END + 0x325, // size 172, flags MIRROR_SELF
	...
	PLAYER_FARSIGHT                                  = UNIT_END + 0x3D1, // size 2, flags MIRROR_SELF
	PLAYER_FIELD_KNOWN_TITLES                        = UNIT_END + 0x3D3, // size 10, flags MIRROR_SELF
	PLAYER_FIELD_COINAGE                             = UNIT_END + 0x3DD, // size 2, flags MIRROR_SELF
	PLAYER_XP                                        = UNIT_END + 0x3DF, // size 1, flags MIRROR_SELF
	PLAYER_NEXT_LEVEL_XP                             = UNIT_END + 0x3E0, // size 1, flags MIRROR_SELF
    ...
    PLAYER_SKILL_MAX_RANK_0                          = UNIT_END + 0x4A1,
    PLAYER_SKILL_TALENT_0                            = UNIT_END + 0x521,
    PLAYER_SKILL_UNKNOWN                             = UNIT_END + 0x56D,
...
enum EGameObjectFields
{
    ...
    GAMEOBJECT_FIELD_DISPLAY_ID                      = OBJECT_END + 0x2,
    GAMEOBJECT_FIELD_FLAGS                           = OBJECT_END + 0x3,
    GAMEOBJECT_FIELD_PARENT_ROTATION                 = OBJECT_END + 0x4,
    GAMEOBJECT_FIELD_FACTION_TEMPLATE                = OBJECT_END + 0x8,
    GAMEOBJECT_FIELD_LEVEL                           = OBJECT_END + 0x9,
    GAMEOBJECT_FIELD_PERCENT_HEALTH                  = OBJECT_END + 0xA,
    GAMEOBJECT_FIELD_STATE_SPELL_VISUAL_ID           = OBJECT_END + 0xB,
