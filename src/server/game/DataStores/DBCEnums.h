...
enum AchievementCriteriaAdditionalCondition
{
	...
	ACHIEVEMENT_CRITERIA_ADDITIONAL_CONDITION_COMPLETE_QUEST_NOT_IN_GROUP = 35, // NYI related to timed completing-quests achievements
...
enum AchievementCriteriaTypes
{
	...
	ACHIEVEMENT_CRITERIA_TYPE_GUILD_CHALLENGE = 138, // struct { Flag flag; uint32 count; } 1: Guild Dungeon, 2:Guild Challenge, 3:Guild battlefield
	ACHIEVEMENT_CRITERIA_TYPE_GUILD_CHALLENGE_COUNT = 139, // struct { uint32 count; } Guild Challenge
...
enum VehicleSeatFlags
{
	...
	VEHICLE_SEAT_FLAG_PASSENGER_NOT_SELECTABLE = 0x00100000,           // https://github.com/TrinityCore/TrinityCore/commit/13208ff25706bf23b428a67452d1b5fa26c7ceec
