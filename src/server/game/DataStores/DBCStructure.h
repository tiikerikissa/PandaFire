...
struct MapEntry
{
	...
	uint32  map_type;                                       // 2
	//uint32 unk_1;                                         // 3
	//uint32 unk_2;                                         // 4        4.0.1 string: azeroth or null
...
{
	uint32      id;                                         // 0
	uint32      spellId[MAX_OVERRIDE_SPELL];                // 1-1
	//uint32      unk_0;                                    // 11
...
struct SpellShapeshiftEntry
{
	...
	// uint32 unk_320_2;                                    // 2 - always 0
	uint32    Stances;                                      // 1 - m_shapeshiftMask
	// uint32 unk_320_3;                                    // 4 - always 0
