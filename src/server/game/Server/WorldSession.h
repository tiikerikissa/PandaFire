...
class WorldSession
{
    ...
    public:                                                 // opcodes handlers
		...
		void HandleUpgradeItemQueryOpcode(WorldPacket& recvPacket);
		void SendUpgradeItemResult(uint64 guid);
