...
void WorldSession::HandleCreatureQueryOpcode(WorldPacket & recvData)
{
    ...
    if (info)
    {
        ...
        sLog->outInfo(LOG_FILTER_NETWORKIO, "WORLD: CMSG_CREATURE_QUERY '%s' - Entry: %u.", info->Name.c_str(), entry);
        ...
        sLog->outInfo(LOG_FILTER_NETWORKIO, "WORLD: Sent SMSG_CREATURE_QUERY_RESPONSE");
    }
    else
        sLog->outInfo(LOG_FILTER_NETWORKIO, "WORLD: CMSG_CREATURE_QUERY - NO CREATURE INFO! (ENTRY: %u)", entry);
}
