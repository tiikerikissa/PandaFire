...
#define GOSSIP_GOHORDE          "Take me to Shrine of Two Moons."
#define GOSSIP_GOALLIANCE       "Take me to Shrine of Seven Stars."
...
public:
    ...
    bool OnGossipHello(Player* player, Creature* creature)
    {
        ...
        case 17209:
			...
			break;
		case 71939: // Chi-Ro the Skytamer (horde)
			if (player->GetQuestStatus(33232) == QUEST_STATUS_INCOMPLETE) // quest is complete Journey to the Timeless Isle
				player->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_GOHORDE, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 31);
			break;
		case 71940: // Michi Windblossom (alliance)
			if (player->GetQuestStatus(33231) == QUEST_STATUS_INCOMPLETE) // quest is complete Journey to the Timeless Isle
				player->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_GOALLIANCE, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 32);
			break;
        }
    ...
    bool OnGossipSelect(Player* player, Creature* creature, uint32 /*sender*/, uint32 action)
    {
        ...
        case GOSSIP_ACTION_INFO_DEF + 30:
			...
			break;
		case GOSSIP_ACTION_INFO_DEF + 31: // timelessisle horde
			player->CLOSE_GOSSIP_MENU();
			player->TeleportTo(870, 1580.60f, 892.65f, 473.60f, 4.68f);
			break;
		case GOSSIP_ACTION_INFO_DEF + 32: // timelessisle alliance
			player->CLOSE_GOSSIP_MENU();
			player->TeleportTo(870, 895.41f, 333.69f, 506.09f, 1.77f);
			break;
        }
