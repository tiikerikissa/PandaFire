...
enum TimeLostShrine
{
	...
	SPELL_CHIJI_HOPE = 147283,
	SPELL_XUEN_STRENGTH = 147284,
	ORDOS_BURNING_SACRIFICE = 147285,
};

class go_Time_Lost_Shrine : public GameObjectScript
{
public:
	go_Time_Lost_Shrine() : GameObjectScript("go_Time_Lost_Shrine") { }
	...
	bool OnGossipHello(Player* player, GameObject* /*go*/)
	{
		...
		player->CastSpell(player, SPELL_CHIJI_HOPE, true);
		return false;

		//player->CastSpell(player, SPELL_XUEN_STRENGTH, true);
		//return false;

		//player->CastSpell(player, ORDOS_BURNING_SACRIFICE, true);
		//return false;
	}
};
